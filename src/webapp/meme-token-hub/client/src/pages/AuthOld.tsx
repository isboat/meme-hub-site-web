      ...
      if (ready && authenticated && privyUser) {
        try {
          ...
          if (isNewUser) {
            ...
            setTimeout(() => navigate('/create-profile'), 1500); // Navigate to create profile
          } else {
            setAuthStatusMessage('Authenticated successfully! Redirecting...');
            setTimeout(() => navigate('/dashboard'), 1500); // Navigate to dashboard
          }
        } catch (error: any) {
  ...
  return (
    <AuthContainer theme={theme}>
      <AuthCard theme={theme}>
        <Title theme={theme}>Welcome to MemeTokenHub</Title>
